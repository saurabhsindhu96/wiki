...
+ **`"params"`** contains general chain parameters:
  ...
  + `"eip658Transition"` [EIP658](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-658.md) transition block number.
  + `"eip155Transition"` [EIP155](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-155.md) transition block number.
